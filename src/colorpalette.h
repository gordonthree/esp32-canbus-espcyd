...
/**
 * @brief Simple RGB structure to replace NeoPixelBus dependency.
 * @details This matches the data layout expected by RgbColor constructors.
 */
struct RgbColor {
    uint8_t R;
    uint8_t G;
    ...
    /* Constructor to allow RgbColor(r, g, b) syntax */
